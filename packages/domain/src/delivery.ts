...
export const agentDestinations: Partial<Record<string, DestinationGuide>> = {
 ...
 'outbound-voice-sdr':{kind:'calls',headline:'ElevenLabs will dial after bind',takeaway:'No live dial in this pass. DAVID writes the opening script; ElevenLabs is the intended outbound voice layer. This agent does not find leads.',connectedNote:'Call tooling is recorded. Copy the script; live ElevenLabs dial is not enabled in this pass.'},
 'ai-receptionist':{kind:'calls',headline:'Inbound greeting is recorded',takeaway:'No live answer in this pass. ElevenLabs Conversational AI is the inbound layer. Record greeting, hours, and a booking link.',connectedNote:'Call tooling is recorded. Live inbound telephony is not enabled in this pass.'},
