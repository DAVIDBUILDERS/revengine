...
test("hosted workspace works without an operational API and survives refresh", async ({ page, browser }) => {
  ...
  await expect(page.getByRole("button", { name: "Open Technical SEO Monitor work" })).toBeVisible();
  await expect(page.getByRole("button", { name: "Open LinkedIn Outreach Assistant work" })).toBeVisible();
  await expect(page.getByRole("button", { name: "Open Partner Development work" })).toBeVisible();
  await expect(page.getByRole("button", { name: "Open Outbound Email SDR work" })).toBeVisible();
  await expect(page.getByRole("button", { name: "Open RFP Opportunity Scout work" })).toBeVisible();
  ...
  await page.getByRole("button", { name: /LinkedIn Outreach Assistant/ }).first().click();
  await expect(page.getByRole("region", { name: "LinkedIn Outreach Assistant workbench" })).toBeVisible();
  ...
  await expect(page.getByText("Human replies")).toBeVisible();
  await page.getByRole("button", { name: "Open Technical SEO Monitor work" }).click();
  ...
  await otherPage.getByRole("button", { name: "Open Technical SEO Monitor work" }).click();
