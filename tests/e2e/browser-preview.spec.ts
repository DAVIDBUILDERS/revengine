...
test("hosted workspace works without an operational API and survives refresh", async ({ page, browser }) => {
  ...
  await expect(page.getByText("This capability is not implemented yet.")).toBeVisible();
  await page.getByRole("button", { name: "Record needed systems" }).click();
  await expect(page.getByRole("heading", { name: "Connections", exact: true })).toBeVisible();
  await page.locator("details.company-map-planning > summary").click();
  await expect(page.locator('[data-system="social"]')).toContainText("Engineering required");
  await expect(page.locator('[data-system="social"]')).toContainText("no OAuth");
