...
export function Conversation(props:ScreenProps){
 ...
 const title:Record<BriefingStep,string>={welcome:`Let’s get to know ${a.company.name||'your company'}.`,website:'What’s your company’s website?',description:'Tell us a little about your business.',name:'What should we call you?',goal:'What would make the biggest difference right now?','other-goal':'What would you like to accomplish?',research:'Here’s what we can learn from your website.','company-name':'What’s your company called?',offer:'What’s your main offer?',customers:'Who do you help?',summary:'Here’s what we learned about your business.','proposal-source':'Where do your proposals live today?','conversion-action':'What action should visitors take?',recommendation:'Here’s where I’d start.',access:'May we use these sources for your first task?',budget:'What’s a comfortable spending limit?',review:'Review this preparation permission.',finish:`We’ve saved what we learned about ${a.company.name||'your business'}.`};
